...
import {View, Text, StyleSheet, FlatList, SectionList, ActivityIndicator, TouchableOpacity, ViewPropTypes} from 'react-native'
...
class RefreshListView extends PureComponent<Props, State> {
  ...
  render() {
    ...
    var ComponentDisplay = null;
    if(this.props.componentName == 'FlatList'){
      ComponentDisplay = 'FlatList'
    }else if(this.props.componentName == 'SectionList'){
      ComponentDisplay = 'SectionList'
    }

    if(ComponentDisplay == 'FlatList'){
      let {renderItem, sections, ...rest} = this.props
      return (
        < FlatList
    ...
    }else if(ComponentDisplay == 'SectionList'){
